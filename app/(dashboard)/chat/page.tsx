...
export default function GlobalChatPage() {
  ...
  return (
    <div className="flex flex-col w-full h-[calc(100dvh-4rem)] relative bg-background -mx-2 px-2 sm:-mx-4 sm:px-4">
      {/* Header */}
      ...
      <div 
        ...
        className="flex-1 min-h-0 overflow-y-auto py-4 space-y-5 pb-4 scroll-smooth -mx-2 px-2 sm:-mx-4 sm:px-4"
      >
        {isLoading ? (
      ...
      {showScrollArrow && (
        <button
          ...
          className="absolute bottom-24 right-4 z-30 brutal flex w-12 h-12 animate-bounce items-center justify-center rounded-full bg-white border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] text-black hover:bg-zinc-100"
